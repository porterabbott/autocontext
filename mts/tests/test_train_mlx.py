...
def test_training_step_reduces_loss() -> None:
    ...
    from mts.training.autoresearch.train import GPTModel, ModelConfig, compute_loss
...
def test_summary_block_format() -> None:
    ...
    from mts.training.autoresearch.train import format_summary
...
def test_checkpoint_save_load(tmp_path: str) -> None:
    ...
    from mts.training.autoresearch.train import GPTModel, ModelConfig, load_checkpoint, save_checkpoint
