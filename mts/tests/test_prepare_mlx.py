...
def test_bpe_training(tmp_path: Path) -> None:
    ...
    from mts.training.autoresearch.prepare import train_tokenizer
...
def test_dataloader_shape(tmp_path: Path) -> None:
    ...
    from mts.training.autoresearch.prepare import create_dataloader
...
def test_assess_strategy_quality_game_scenario() -> None:
    ...
    from mts.training.autoresearch.prepare import assess_strategy_quality
