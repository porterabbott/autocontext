...
from mts.integrations.primeintellect.client import PrimeIntellectClient
...
def test_execute_strategy_uses_sandbox_lifecycle(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("mts.integrations.primeintellect.client.AsyncSandboxClient", _SuccessAsyncClient)
...
def test_execute_strategy_falls_back_when_enabled(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("mts.integrations.primeintellect.client.AsyncSandboxClient", _FailingAsyncClient)
