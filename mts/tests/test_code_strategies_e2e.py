...
from mts.scenarios.base import ExecutionLimits, Observation, Result
...
class TestCodeStrategyE2EValid:
    def test_code_strategy_through_monty_executor(self) -> None:
        ...
        with patch("mts.execution.executors.monty._create_monty", return_value=mock):
...
class TestCodeStrategyE2EWithSupervisor:
    def test_code_strategy_through_execution_supervisor(self) -> None:
        from mts.execution.supervisor import ExecutionInput, ExecutionSupervisor
