...
def test_ecosystem_phase_dataclass() -> None:
    from mts.loop.ecosystem_runner import EcosystemPhase
...
def test_ecosystem_config_default_phases() -> None:
    from mts.loop.ecosystem_runner import EcosystemConfig
...
def test_ecosystem_config_custom_phases() -> None:
    from mts.loop.ecosystem_runner import EcosystemConfig, EcosystemPhase
...
def test_ecosystem_run_id_pattern() -> None:
    from mts.loop.ecosystem_runner import EcosystemRunner
