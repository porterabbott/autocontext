...
from mts.scenarios.base import ExecutionLimits, ReplayEnvelope, Result
...
class TestMontyExecutorExecute:
    ...
    def test_execute_returns_result_and_replay(self) -> None:
        ...
        with patch("mts.execution.executors.monty._create_monty", return_value=mock_monty):
...
class TestMontyExecutorErrorHandling:
    def test_monty_creation_error_wrapped(self) -> None:
        ...
        with patch("mts.execution.executors.monty._create_monty", side_effect=RuntimeError("bad code")):
